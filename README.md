...
| **Декодеры** | UART, MIDI, CAN, CAN FD, LIN, SENT, 1-Wire (DS18B20), DHT11/22, WS2812, NEC IR, Sony SIRC, EV1527/PT2262, DShot, SPI! (по одному щупу, вручную), SWO/ITM, SWD, Manchester, RC5/RC6, DALI, KNX TP1, Servo PWM, CPPM, сырые уровни, автоопределение — [как устроен каждый](doc/decoders.md) |
