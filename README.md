...
| **Декодеры** | UART, MIDI, CAN, LIN, SENT, 1-Wire (DS18B20), DHT11/22, WS2812, NEC IR, EV1527, DShot, SPI! (по одному щупу), SWO/ITM, SWD, Manchester, RC5/RC6, DALI, KNX TP1, Servo PWM, сырые уровни, автоопределение — [все двадцать подробно](doc/decoders.md) |
