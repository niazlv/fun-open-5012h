...
256 строк не влезают в 240 точек панели. `Crop` держит масштаб и теряет
шестнадцать строк, деля их между верхом и низом (`Top line`); `Squash`
выбрасывает одну строку из шестнадцати и показывает всё.
