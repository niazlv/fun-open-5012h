...
- **Амплитуды — не только размах.** `Vp` — пик от **земли**, то есть
  ...
  сторону от земли пик, это половина смысла. `Vamp` — размах между **плоскими**
  уровнями (`Vtop − Vbase`), без выброса и звона, которые сидят в Vpp: у
  меандра с 4% выброса Vpp читается 2.15 В, а Vamp — 2.00 В. Вертикальная
  позиция из всех трёх вычтена: сдвиньте луч на две клетки, показания не
  шевельнутся
