...
static const char *const g_calib_help_lines[] =
{
  ...
  "SHIFT+L/R    - timebase, SHIFT+U/D - volts",
  "AUTO         - auto-calibrate Z, D, O and N",
  ...
  "            CONVERTER and shared by every",
  "            range. Measured, not typed.",
  "",
  INFO_HEAD "Procedure",
  ...
  "",
  INFO_HEAD "The bend (N)",
  "Step 4 of the AUTO run, and it needs no",
  "reference at all: the offset DAC is 12 bits",
  "and the converter is 8, so stepping the DAC",
  "across the window with the input shorted",
  ...
  "converter bending, and it is the same bend",
  "on every range - the attenuator is",
  "resistors.",
  "",
  "It matters because a gain trim cannot",
  "describe it: calibrate 9 V right on a bent",
  "chain and 5 V goes wrong by the difference.",
  "Both converters are measured; they differ.",
  "Takes about ten seconds and reports the",
  "size of what it found, as a percentage of",
  "four divisions.",
  "",
